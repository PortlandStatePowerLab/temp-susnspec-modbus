#include "include/sunspec/sunspec_inverter_single_phase.hpp"

using namespace sunspec;

SunSpec_Inverter_Single_Phase::SunSpec_Inverter_Single_Phase(/*101*/)
{
    id = "1";
    length = 50;
...
SunSpec_Inverter_Single_Phase::~SunSpec_Inverter_Single_Phase()
{
