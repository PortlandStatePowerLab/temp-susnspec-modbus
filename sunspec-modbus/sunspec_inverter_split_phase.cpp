#include "include/sunspec/sunspec_inverter_split_phase.hpp"

using namespace sunspec;

SunSpec_Inverter_Split_Phase::SunSpec_Inverter_Split_Phase(/*101*/)
{
    id = "1";
    length = 50;
...
SunSpec_Inverter_Split_Phase::~SunSpec_Inverter_Split_Phase()
{
